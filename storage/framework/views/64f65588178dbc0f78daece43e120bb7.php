...
<head>
    ...
    <style>
        ...
        .main-wrapper {
            height: 100vh;
            width: 100vw;
            background: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('<?php echo e(asset('img/tourism-bg.png')); ?>');
...
<?php /**PATH C:\xampp\htdocs\ekowisataID\resources\views/auth/login.blade.php ENDPATH**/ ?>