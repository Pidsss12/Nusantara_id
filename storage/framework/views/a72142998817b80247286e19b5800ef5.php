        ...
        <div class="premium-card p-4" style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.9) 0%, rgba(118, 75, 162, 0.9) 100%); border: none;">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h2 class="mb-0 fw-bold text-white mt-1"><?php echo e($stats['total_bookings']); ?></h2>
                    <div class="mt-2">
        ...
        <div class="premium-card p-4" style="background: linear-gradient(135deg, rgba(25, 135, 84, 0.9) 0%, rgba(32, 201, 151, 0.9) 100%); border: none;">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h2 class="mb-0 fw-bold text-white mt-1"><?php echo e($stats['confirmed_bookings']); ?></h2>
                    <div class="mt-2">
                        <span class="badge rounded-pill text-white small" style="background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(5px); border: 1px solid rgba(255, 255, 255, 0.1);">
                           Ready to go
                        </span>
        ...
        <div class="premium-card p-4" style="background: linear-gradient(135deg, rgba(255, 193, 7, 0.9) 0%, rgba(255, 152, 0, 0.9) 100%); border: none;">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h2 class="mb-0 fw-bold text-white mt-1"><?php echo e($stats['pending_bookings']); ?></h2>
                    <div class="mt-2">
                        <span class="badge rounded-pill text-white small" style="background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(5px); border: 1px solid rgba(255, 255, 255, 0.1);">
                           Awaiting
                        </span>
        ...
        <div class="premium-card p-4" style="background: linear-gradient(135deg, rgba(13, 202, 240, 0.9) 0%, rgba(13, 110, 253, 0.9) 100%); border: none;">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h2 class="mb-0 fw-bold text-white mt-1">Rp <?php echo e(number_format($stats['total_spent'] / 1000000, 1)); ?>M</h2>
                    <div class="mt-2">
                        <span class="badge rounded-pill text-white small" style="background: rgba(255, 255, 255, 0.2); backdrop-filter: blur(5px); border: 1px solid rgba(255, 255, 255, 0.1);">
                           Investment
                        </span>
            ...
            <div class="pe-2" style="max-height: 400px; overflow-y: auto;">
                ...
                <div class="d-flex align-items-center mb-4 p-3 rounded-4" style="background: rgba(25, 135, 84, 0.03); border: 1px solid rgba(25, 135, 84, 0.05);">
                    <div class="rounded-4 p-3 me-3 text-center d-flex flex-column justify-content-center" style="min-width: 65px; height: 65px; background: linear-gradient(135deg, var(--primary-green) 0%, var(--accent-green) 100%); color: white;">
                        <span class="fs-5 fw-bold lh-1"><?php echo e($booking->visit_date->format('d')); ?></span>
                        <small style="font-size: 0.65rem; text-uppercase; opacity: 0.8;"><?php echo e($booking->visit_date->format('M')); ?></small>
                    </div>
                    <div class="flex-grow-1">
                        <h6 class="mb-1 fw-bold" style="color: var(--text-title)"><?php echo e($booking->destination->name); ?></h6>
                        <div class="d-flex align-items-center gap-2">
                            <small class="text-muted"><i class="bi bi-people me-1"></i><?php echo e($booking->participants); ?> pax</small>
                            <span class="badge rounded-pill" style="background: rgba(25, 135, 84, 0.1); color: var(--primary-green); font-size: 0.65rem;"><?php echo e($booking->status); ?></span>
                        </div>
                    </div>
                    <a href="<?php echo e(route('user.bookings')); ?>" class="btn btn-sm px-3 rounded-pill text-white" style="background: var(--primary-green); font-size: 0.75rem;">Details</a>
                </div>
                ...
                <div class="text-center py-5 text-muted">
                    ...
                    <a href="<?php echo e(route('destinations.index')); ?>" class="btn btn-success rounded-pill px-4">Book Now</a>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="col-lg-6">
        <div class="premium-card p-4 h-100">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('user.bookings')); ?>" class="text-success text-decoration-none small fw-bold">View All <i class="bi bi-arrow-right ms-1"></i></a>
            </div>
            <div class="pe-2" style="max-height: 400px; overflow-y: auto;">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 p-3 rounded-4" style="background: rgba(0,0,0,0.02);">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="mb-1 fw-bold" style="color: var(--text-title)">#<?php echo e($booking->booking_code); ?></h6>
                            <small class="text-muted d-block"><?php echo e($booking->destination->name); ?></small>
                        </div>
                    </div>
                    <div class="text-end">
                        <div class="fw-bold text-success mb-1">Rp <?php echo e(number_format($booking->total_amount, 0, ',', '.')); ?></div>
                        <span class="badge rounded-pill px-3" style="background: <?php echo e($booking->status == 'Confirmed' ? 'rgba(25, 135, 84, 0.1)' : ($booking->status == 'Pending' ? 'rgba(255, 193, 7, 0.1)' : 'rgba(220, 53, 69, 0.1)')); ?>; color: <?php echo e($booking->status == 'Confirmed' ? '#198754' : ($booking->status == 'Pending' ? '#ffc107' : '#dc3545')); ?>; font-size: 0.7rem;">
...
var backendDestinations = <?php echo json_encode($destinations, 15, 512) ?>;
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ekowisataID\resources\views/user/dashboard.blade.php ENDPATH**/ ?>