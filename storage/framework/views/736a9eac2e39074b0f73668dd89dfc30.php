...
<?php $__env->startSection('page-subtitle', 'View and manage your booking history'); ?>
...
<div class="premium-card p-4 mb-4">
    <form action="<?php echo e(route('user.bookings')); ?>" method="GET" class="row g-3 align-items-end">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            ...
            <input type="date" name="date_from" class="form-control border-0 shadow-sm rounded-3 py-2 px-3" value="<?php echo e(request('date_from')); ?>" style="background: rgba(255,255,255,0.8);">
        </div>
        <div class="col-md-3">
            <p class="mb-2 small fw-bold text-uppercase opacity-75" style="letter-spacing: 1px; font-size: 0.7rem;">To Date</p>
            <input type="date" name="date_to" class="form-control border-0 shadow-sm rounded-3 py-2 px-3" value="<?php echo e(request('date_to')); ?>" style="background: rgba(255,255,255,0.8);">
        </div>
        <div class="col-md-3">
            <div class="d-flex gap-2">
                ...
                <a href="<?php echo e(route('user.bookings')); ?>" class="btn btn-light rounded-pill px-4 py-2 fw-bold text-muted border shadow-sm" style="min-width: 120px;"><i class="bi bi-arrow-counterclockwise me-2"></i>Reset</a>
            </div>
        </div>
    </form>
</div>
...
<div class="row g-4">
    ...
    <div class="col-lg-6">
        <div class="premium-card p-4 h-100">
            <div class="d-flex justify-content-between align-items-start mb-4">
                <div>
                    <h6 class="fw-bold mb-1" style="color: var(--text-title); font-size: 1rem;"><?php echo e(optional($booking->destination)->name ?? 'Destinasi tidak ditemukan'); ?></h6>
                    <span class="badge rounded-pill px-2 py-1" style="background: rgba(0,0,0,0.06); color: #475569; font-size: 0.65rem; font-family: monospace;">#<?php echo e($booking->booking_code); ?></span>
                </div>
                <span class="badge rounded-pill px-3 py-2 fw-bold text-uppercase" style="background: <?php echo e($booking->status == 'Confirmed' ? 'rgba(25, 135, 84, 0.1)' : ($booking->status == 'Pending' ? 'rgba(255, 193, 7, 0.1)' : 'rgba(220, 53, 69, 0.1)')); ?>; color: <?php echo e($booking->status == 'Confirmed' ? '#198754' : ($booking->status == 'Pending' ? '#e6a800' : '#dc3545')); ?>; font-size: 0.65rem; letter-spacing: 0.5px; border: 1px solid rgba(0,0,0,0.05);">
                ...
                <div class="col-6">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <span class="fw-bold" style="font-size: 0.9rem; color: var(--text-title);"><?php echo e($booking->visit_date ? $booking->visit_date->format('d M Y') : '-'); ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <span class="fw-bold" style="font-size: 0.9rem; color: var(--text-title);"><?php echo e($booking->participants); ?> Pax</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="pt-3 border-top d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h5 class="fw-bold text-success mb-0">Rp <?php echo e(number_format($booking->total_amount, 0, ',', '.')); ?></h5>
                </div>
                <div class="d-flex gap-2">
                    <button class="btn btn-premium-action btn-premium-success" data-bs-toggle="modal" data-bs-target="#detailModal<?php echo e($booking->id); ?>">
                        <i class="bi bi-info-circle"></i> Details
                    </button>
                    <?php if(in_array($booking->status, ['Pending', 'Confirmed'])): ?>
                    <form action="<?php echo e(route('user.bookings.cancel', $booking)); ?>" method="POST" class="cancel-form d-inline-block">
    ...
    <!-- Detail Modal -->
    <div class="modal fade" id="detailModal<?php echo e($booking->id); ?>" tabindex="-1">
            ...
            <div class="modal-content border-0 shadow-lg" style="border-radius: 30px; overflow: hidden;">
                ...
                <div class="modal-body">
                    <table class="table table-borderless">
                        <tr><th width="40%">Booking Code</th><td>#<?php echo e($booking->booking_code); ?></td></tr>
                        ...
                        <tr><th>Booked At</th><td><?php echo e($booking->created_at->format('d M Y H:i')); ?></td></tr>
                    </table>
                </div>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="card shadow-sm border-0 rounded-4">
            <div class="card-body text-center py-5">
                ...
                <a href="<?php echo e(route('destinations.index')); ?>" class="btn btn-success rounded-pill">
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ekowisataID\resources\views/user/bookings.blade.php ENDPATH**/ ?>