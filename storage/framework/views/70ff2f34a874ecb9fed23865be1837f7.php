...
<div class="premium-card p-4 mb-4">
    <form action="<?php echo e(route('user.invoices')); ?>" method="GET" class="row g-3 align-items-end">
        <div class="col-md-4">
            ...
            <select name="payment_status" class="form-select premium-card border-0 py-2 px-3 shadow-none">
                ...
                <option value="Pending" <?php echo e(request('payment_status') == 'Pending' ? 'selected' : ''); ?>>Pending Verification</option>
        ...
        <div class="col-md-4">
            ...
            <a href="<?php echo e(route('user.invoices')); ?>" class="btn btn-light px-4 rounded-pill ms-2 text-muted">Reset</a>
        </div>
    </form>
</div>
    ...
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    <td class="px-4 py-3 fw-bold text-success"><?php echo e($invoice->invoice_code); ?></td>
                    <td class="py-3"><?php echo e($invoice->invoice_date ? $invoice->invoice_date->format('d M Y') : '-'); ?></td>
                    <td class="py-3 fw-medium" style="color: var(--text-title)"><?php echo e($invoice->destination->name ?? '-'); ?></td>
                    <td class="py-3 fw-bold text-success">Rp <?php echo e(number_format($invoice->total_amount, 0, ',', '.')); ?></td>
                    <td class="py-3">
                        <span class="badge rounded-pill px-3 py-1" style="background: <?php echo e($invoice->status == 'Confirmed' ? 'rgba(25, 135, 84, 0.1)' : 'rgba(255, 193, 7, 0.1)'); ?>; color: <?php echo e($invoice->status == 'Confirmed' ? '#198754' : '#ffc107'); ?>; border: 1px solid rgba(0,0,0,0.02);">
                    ...
                    <td class="py-3 text-end px-4">
                        <a href="<?php echo e(route('user.invoices.show', $invoice)); ?>" class="btn btn-sm px-3 rounded-pill text-white" style="background: var(--primary-green); font-size: 0.75rem;">
                            View
                        </a>
                    </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="7" class="text-center py-5 text-muted">
                            ...
                            <a href="<?php echo e(route('destinations.index')); ?>" class="btn btn-success btn-sm rounded-pill mt-2">
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ekowisataID\resources\views/user/invoices.blade.php ENDPATH**/ ?>