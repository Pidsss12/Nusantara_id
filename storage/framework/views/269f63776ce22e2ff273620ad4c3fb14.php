...
<link rel="stylesheet" href="<?php echo e(asset('css/admin-dashboard-map.css')); ?>?v=<?php echo e(filemtime(public_path('css/admin-dashboard-map.css'))); ?>">
            ...
            <div class="card-body p-4 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h2 class="display-6 fw-bold mb-1" id="totalUsersCount" style="font-size: 2.5rem;">
                        <?php echo e(isset($users) && count($users) > 0 ? number_format(count($users)) : '0'); ?>
...
<script>
    window.NusantaraUserMapData = <?php echo json_encode($users ?? [], 15, 512) ?>;
</script>
<script src="<?php echo e(asset('js/admin-dashboard.js')); ?>?v=<?php echo e(filemtime(public_path('js/admin-dashboard.js'))); ?>"></script>
<?php $__env->stopSection(); ?>
