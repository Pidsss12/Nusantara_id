        ...
        <div id="header-content">
            ...
            <div id="auth-buttons">
                ...
                <?php else: ?>
                    ...
                    <?php endif; ?>
                    <a href="<?php echo e(route('user.dashboard')); ?>" class="btn-register">
                        <i class="bi bi-grid me-1"></i>Dashboard
                    </a>
                    <a href="<?php echo e(route('logout')); ?>" class="btn-login" 
...
<?php /**PATH C:\xampp\htdocs\ekowisataID\resources\views/layouts/app.blade.php ENDPATH**/ ?>