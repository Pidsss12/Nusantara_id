        ...
        <div class="top-bar">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0 fw-bold" style="color: var(--text-title)"><?php echo $__env->yieldContent('page-title', 'Overview'); ?></h4>
                        <small class="text-muted">Welcome back, <?php echo e(explode(' ', Auth::user()->name)[0]); ?>!</small>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\ekowisataID\resources\views/layouts/admin.blade.php ENDPATH**/ ?>