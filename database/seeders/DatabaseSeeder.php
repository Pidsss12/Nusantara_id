...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $destinations = [
            ...
            ['province_id' => 2, 'name' => 'Candi Borobudur', 'slug' => 'borobudur', 'category' => 'Heritage', 'description' => 'Candi Buddha terbesar di dunia, warisan UNESCO', 'price' => 150000, 'location' => 'Magelang, Jawa Tengah', 'rating' => 4.8, 'bookings_count' => 423],
            ['province_id' => 5, 'name' => 'Taman Nasional Komodo', 'slug' => 'komodo', 'category' => 'Wildlife', 'description' => 'Habitat asli komodo, kadal terbesar di dunia', 'price' => 750000, 'location' => 'Labuan Bajo, NTT', 'rating' => 4.9, 'bookings_count' => 387],
            ['province_id' => 3, 'name' => 'Gunung Bromo', 'slug' => 'bromo', 'category' => 'Mountain', 'description' => 'Gunung berapi aktif dengan pemandangan matahari terbit spektakuler', 'price' => 350000, 'location' => 'Probolinggo, Jawa Timur', 'rating' => 4.7, 'bookings_count' => 298],
            ['province_id' => 6, 'name' => 'Danau Toba', 'slug' => 'danau-toba', 'category' => 'Lake', 'description' => 'Danau vulkanik terbesar di dunia dengan Pulau Samosir', 'price' => 200000, 'location' => 'Sumatera Utara', 'rating' => 4.6, 'bookings_count' => 245],
